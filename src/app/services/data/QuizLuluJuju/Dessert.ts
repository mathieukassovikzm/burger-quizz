  ...
  questions: [
    {
      ...
      category: Category,
      reponse: [
        { name: 'Claire Chazal', imgUrl: '/assets/desserts/ganache-ketchup-rep1.jpg' },
        { name: 'Rihanna', imgUrl: '/assets/desserts/ganache-ketchup-rep2.jpg' },
        { name: 'Lulu', imgUrl: '/assets/desserts/ganache-ketchup-rep3.jpg' },
      ],
    },
    {
      question: 'A qui appartient ces 3 visages?',
      ...
      category: Category,
      reponse: [
        { name: 'Prince Charles', imgUrl: '/assets/desserts/ganache-mayo-rep1.jpg' },
        { name: 'Juju', imgUrl: '/assets/desserts/ganache-mayo-rep2.jpg' },
        { name: 'George Clooney', imgUrl: '/assets/desserts/ganache-mayo-rep3.jpeg' },
      ],
    },
  ],
};
